...
public class SuperChromeBase {
    ...
    System.out.println("*********** SuperChromeBase: BeforeTest is Start ******************");
    System.out.println("*********** Your current Project directory is:- " +projectdir);
    ...
    //  cap.setCapability(AndroidMobileCapabilityType.CHROMEDRIVER_EXECUTABLE,driverpathString);
     ...
     try {
      		  ...
      		  // cap.setCapability(AndroidMobileCapabilityType.CHROMEDRIVER_EXECUTABLE,driverpathString); //without chromedriver cap ,program running
     		    ...
     		    System.out.println("******************  SuperChromeBase setup is successfully done ****************"); 
